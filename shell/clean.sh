...
ps -ef | grep "gagent" | grep $LOGNAME | kill -9 `awk '{print $2}'`
ps -ef | grep "glocator" | grep $LOGNAME | kill -9 `awk '{print $2}'`
ps -ef | grep "gloctl" | grep $LOGNAME | kill -9 `awk '{print $2}'`
ps -ef | grep "glsnr" | grep $LOGNAME | kill -9 `awk '{print $2}'`
ps -ef | grep "cyclone" | grep $LOGNAME | kill -9 `awk '{print $2}'`
ps -ef | grep "cymon" | grep $LOGNAME | kill -9 `awk '{print $2}'`
